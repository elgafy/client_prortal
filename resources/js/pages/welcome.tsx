...
export default function Welcome() {
    ...
    return (
        <>
            <Head title="Welcome" />
            <div className="flex min-h-screen flex-col items-center bg-[#fffaf0] p-6 text-[#0a0a0a] lg:justify-center lg:p-8 dark:bg-[#0a1a1a]">
                <header className="mb-6 w-full max-w-[335px] text-sm not-has-[nav]:hidden lg:max-w-4xl">
                    <nav className="flex items-center justify-end gap-4">
                        {auth.user ? (
                            <Link
                                href={dashboard()}
                                className="inline-block rounded-sm border border-[#e5e5e5] px-5 py-1.5 text-sm leading-normal text-[#0a0a0a] hover:border-[#d5d0c0] dark:border-[#2a3a3a] dark:text-[#ffffff] dark:hover:border-[#9a9a9a]"
                            >
                                Dashboard
                            </Link>
                        ) : (
                            <Link
                                href={login()}
                                className="inline-block rounded-sm border border-transparent px-5 py-1.5 text-sm leading-normal text-[#0a0a0a] hover:border-[#e5e5e5] dark:text-[#ffffff] dark:hover:border-[#2a3a3a]"
                            >
                                Log in
                            </Link>
                        )}
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#1a2a2a] dark:text-[#ffffff] dark:shadow-[inset_0px_0px_0px_1px_#ffffff2d]">
                            <h1 className="mb-1 font-medium">
                                Let's get started
                            </h1>
                            <p className="mb-2 text-[#6a6a6a] dark:text-[#a0a0a0]">
                                Laravel has an incredibly rich ecosystem.
                                <br />
                                We suggest starting with the following.
                            </p>
                            <ul className="mb-4 flex flex-col lg:mb-6">
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-[#e5e5e5] dark:before:border-[#2a3a3a]">
                                    <span className="relative bg-white py-1 dark:bg-[#1a2a2a]">
                                        <span className="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-[#e5e5e5] bg-[#fffaf0] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-[#2a3a3a] dark:bg-[#1a2a2a]">
                                            <span className="h-1.5 w-1.5 rounded-full bg-[#ebe6d6] dark:bg-[#2a3a3a]" />
                                        </span>
                                    </span>
                                    <span>
                                        Read the
                                        <a
                                            ...
                                            target="_blank"
                                            className="ml-1 inline-flex items-center space-x-1 font-medium text-[#ff4d8b] underline underline-offset-4 dark:text-[#ff4d8b]"
                                        >
                                ...
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-[#e5e5e5] dark:before:border-[#2a3a3a]">
                                    <span className="relative bg-white py-1 dark:bg-[#1a2a2a]">
                                        <span className="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-[#e5e5e5] bg-[#fffaf0] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-[#2a3a3a] dark:bg-[#1a2a2a]">
                                            <span className="h-1.5 w-1.5 rounded-full bg-[#ebe6d6] dark:bg-[#2a3a3a]" />
                                        </span>
                            ...
                            <ul className="flex gap-3 text-sm leading-normal">
                                <li>
                                    <a
                                        ...
                                        target="_blank"
                                        className="inline-block rounded-sm border border-black bg-[#0a0a0a] px-5 py-1.5 text-sm leading-normal text-white hover:border-black hover:bg-black dark:border-[#1a2a2a] dark:bg-[#1a2a2a] dark:text-[#0a0a0a] dark:hover:border-white dark:hover:bg-white"
                                    >
                                        Deploy now
                                    </a>
                                </li>
                        ...
                        <div className="relative -mb-px aspect-[335/364] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#faf5e8] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#0a1a1a]">
                            {/* Laravel Logo */}
                            <svg
                                className="w-full max-w-none translate-y-0 text-[#ff4d8b] opacity-100 transition-all duration-750 dark:text-[#ff4d8b] starting:opacity-0 motion-safe:starting:translate-y-6"
                                viewBox="0 0 438 104"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                            ...
                            {/* 13 */}
                            <svg
                                className="relative -mt-[6.6rem] -ml-8 w-[438px] max-w-none [--stroke-color:#0a0a0a] lg:ml-0 dark:[--stroke-color:#ff6b5a]"
                                viewBox="0 0 440 392"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                                <g className="text-[#0a0a0a] opacity-100 mix-blend-darken transition-all delay-300 duration-750 dark:text-black dark:mix-blend-normal starting:opacity-0">
                                    <mask
                                        id="path-1-mask"
                                ...
                                <g className="text-[#ffb084] opacity-100 transition-all delay-400 duration-750 dark:text-[#1a2a2a] starting:opacity-0 motion-safe:starting:-translate-x-[26px]">
                                    <mask
                                        id="path-2-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="25.3357"
                                ...
                                <g className="text-[#e8b94a] opacity-100 mix-blend-color transition-all delay-400 duration-750 dark:text-[#2a3a3a] dark:mix-blend-hard-light starting:opacity-0 motion-safe:starting:-translate-x-[51px]">
                                    <mask
                                        id="path-3-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="51"
                                ...
                                <g className="text-[#ffb084] opacity-100 mix-blend-multiply transition-all delay-400 duration-750 dark:text-[#2a3a3a] dark:mix-blend-normal starting:opacity-0 motion-safe:starting:-translate-x-[78px]">
                                    <mask
                                        id="path-4-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="76.6643"
                                ...
                                <g className="text-[#ffb084] opacity-100 mix-blend-hard-light transition-all delay-400 duration-750 dark:text-[#1a2a2a] starting:opacity-0 motion-safe:starting:-translate-x-[102px]">
                                    <mask
                                        id="path-5-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="102.329"
                            ...
                            <div className="absolute inset-0 rounded-t-lg shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-t-none lg:rounded-r-lg dark:shadow-[inset_0px_0px_0px_1px_#ffffff2d]"></div>
                        </div>
                    </main>
                </div>
